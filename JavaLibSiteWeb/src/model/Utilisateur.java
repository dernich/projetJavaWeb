...
public class Utilisateur {
    ...
    public Utilisateur(int id, String nom, String prenom, String email, String login, String motdepasse, String rue, int numeromaison, int codepostal, String localite, Pays idPays, String tel) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
