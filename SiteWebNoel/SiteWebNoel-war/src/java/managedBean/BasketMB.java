...
public class BasketMB implements Serializable {
    ...
    public String addArticleList(Article a) {
        dejaPresent = false;
        ...
        if(a.getQuantiteStock() > 0){
             if(!dejaPresent){
                ...
                if(lg.getQuantiteCommande() > a.getQuantiteStock()){
                    subtotal -= lg.getTotalArticle();
                    lg.setQuantiteCommande(a.getQuantiteStock());
                    lg.setTotalA(a.getQuantiteStock() * a.getPrix());
                    subtotal += a.getPrix() * a.getQuantiteStock();
                }else{
    ...
    public String delArticle(LigneCommande ligne) {
