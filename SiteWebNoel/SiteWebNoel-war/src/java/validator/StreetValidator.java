...
public class StreetValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
            ...
            if(!matcher.matches()){
                if(lang.equals("fr")){
                    msg = new FacesMessage("Format de rue invalide. N'entrez pas d'espace en première place ou entièrement des chiffres");
                }
                else {
                    msg = new FacesMessage("Invalid street format. Don't enter space at first or digit at all");
                }
