...
public class PhoneValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
            ...
            if(!matcher.matches()){
                if(lang.equals("fr")){
                    msg = new FacesMessage("Format de téléphone invalide. Example : 082139684 ou 0498135847");
                }
                else {
                    msg = new FacesMessage("Invalid Phone format. Example : 082139684 or 0498135847");
                }
